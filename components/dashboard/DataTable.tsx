          ...
          <tr className="border-b border-line text-left">
            {columns.map((c) => (
              <th
                key={c.key}
                className={cn(
                  "whitespace-nowrap px-3 pb-2 text-xs font-semibold uppercase tracking-wide text-faint first:pl-0 last:pr-0",
              ...
              {columns.map((c) => {
                ...
                return (
                  <td
                    key={c.key}
                    className={cn(
                      "whitespace-nowrap px-3 py-2.5 first:pl-0 last:pr-0",
